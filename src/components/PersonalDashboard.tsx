...
export const PersonalDashboard: React.FC<Props> = ({ accounts, cards, transactions, invoices, selectedDate }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-lg border-4 border-black transition-colors duration-200">
        ...
        <p className={`text-3xl font-black ${totalBalance >= 0 ? 'text-green-600' : 'text-red-600'}`}>
