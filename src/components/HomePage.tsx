...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      {error && (
        <div className="bg-red-100 border-2 border-red-300 text-red-700 font-bold px-4 py-3 rounded-lg">
          ❌ {error}
        </div>
      )}
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border-4 border-black">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-red-50 rounded-lg border-2 border-red-200">
                ...
                <span className="text-2xl font-black text-red-600">{stats?.debtsCreated ?? 0}</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg border-2 border-green-200">
                <span className="font-bold text-green-800">Pagamentos realizados</span>
                <span className="text-2xl font-black text-green-600">{stats?.paymentsMade ?? 0}</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg border-2 border-blue-200">
                <span className="font-bold text-blue-800">Rolês marcados</span>
                <span className="text-2xl font-black text-blue-600">{stats?.eventsCreated ?? 0}</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-orange-50 rounded-lg border-2 border-orange-200">
                ...
                <span className="text-2xl font-black text-orange-600">{stats?.newCaloteiros ?? 0}</span>
              </div>
            </div>
          </div>
        </div>
